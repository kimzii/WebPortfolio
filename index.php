    ...
    <div id="home">
      <div id="content">
        ...
        <div id="content-image">
          <img src="Resources/kim2.svg" alt="photo" height="360px" />
        </div>
      </div>
      ...
      <div id="project-ctn">
        <div id="RockPaperScissor">
          <div class="project-image">
            <button class="visit">
              <a
                href="https://kimzii.github.io/RockPaperScissor/"
                target="_blank"
                >Visit Project</a
              >
            </button>
          ...
          <div class="project-details">
            ...
            <div class="details">
              ...
              <button class="visit-repo">
                <a
                  href="https://github.com/kimzii/RockPaperScissor"
                  target="_blank"
        ...
        <div id="Riffrant">
          <div class="project-image">
            <button class="visit">
              <a href="https://riffrant.vercel.app/" target="_blank"
                >Visit Project</a
              >
            </button>
          </div>
        ...
        <div id="ProverbsWebApp">
          <div class="project-image">
            <button class="visit">
              <a href="https://kimzii.github.io/ProverbsWebApp/" target="_blank"
                >Visit Project</a
              >
            </button>
          </div>
          ...
          <div class="project-details">
            ...
            <div class="details">
              ...
              <button class="visit-repo">
                <a
                  href="https://github.com/kimzii/ProverbsWebApp"
                  target="_blank"
                >
                  <img src="Resources/projects/github-repo.svg" width="28px" />
